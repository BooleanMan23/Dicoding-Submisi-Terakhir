 ...
 */
public class FavoritSerialTvFragment extends Fragment {
    private ProgressBar progressBar;
    public Adapter movieAdapter;
    private RecyclerView movieRecyclerView;
    ArrayList<Movie> movieList ;

    public FavoritSerialTvFragment() {
    ...
    public void prepare(){
        Cursor c = MainActivity.myDatabase.rawQuery("SELECT * FROM favorite WHERE isMovie = 0", null );
        try {
