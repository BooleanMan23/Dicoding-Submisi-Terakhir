...
public class ImageBannerWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "com.example.dicoding_submisi2.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.example.dicoding_submisi2.EXTRA_ITEM";
